...
- [ ] What is React JS and what problems does it try and solve? Support your answer with concepts introduced in class and from your personal research on the web.
    React is a user interface library that helps to quickly and efficiently handle and display large amounts of information. It allows companies like facebook and AirBNB to take their current data and update it without needing to reload the whole page. They can update just what needs to be updated.

- [ ] What does it mean to _think_ in react?
    React has pattern to its process that requires you to think differently then when other libraries.

- [ ] Describe state.
    State is just the data we need for the website. It's called state because we can update the data to a new state of data.

- [ ] Describe props.
    Props is just information/data passed from one component to another. This can be functions, bolleans, arrays, or really anything.
